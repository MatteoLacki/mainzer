...
# # olc.sort_values("run_chimeric_regressiond_intensity", ascending=False).head(3)
# # olc["Nycodenz_2"]
# nyco2 = oions.query("name == 'Nycodenz_Nycodenz' and charge == 1")
# # isotopic_calculator.spectrum("C38H52I6N6O18")

# oions.query("min_isospec_mz >= 1540 and max_isospec_mz <= 1600").sort_values("run_chimeric_regressiond_intensity", ascending=False)
